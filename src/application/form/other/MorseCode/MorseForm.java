...
public class MorseForm extends javax.swing.JPanel {
    ...
    private TextToMorse register;
    private Morse2text login;
    private Animator animator;
    private boolean isLogin;

    public void setAnimate(int animate) {
        layout.setComponentConstraints(register, "pos (30%)-290px-" + animate + " 0.5al n n");
        layout.setComponentConstraints(login, "pos (55%)-10px+" + animate + " 0.5al n n");
        if (animate == 30) {
            if (isLogin) {
    ...
    private void init() {
        ...
        setLayout(layout);
        register = new TextToMorse();
        login = new Morse2text();
        add(register, "pos (30%)-290px 0.5al n n");
        add(login, "pos (55%)-10px 0.5al n n");
