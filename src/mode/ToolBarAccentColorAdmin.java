 ...
 * @author Ratul
 */
public class ToolBarAccentColorAdmin extends JPanel {
    ...
    public ToolBarAccentColorAdmin(AdminMenu menu) {
        this.menu = menu;
        init();
    }
    ...
    private void init() {
        ...
        selectedButton.addActionListener((ActionEvent e) -> {
            ...
            show(ToolBarAccentColorAdmin.this, (int) getWidth() + UIScale.scale(4), y);
        });
