...
import mode.ToolBarAccentColor;
import mode.ToolBarAccentColorAdmin;
...
public class AdminMenu extends JPanel {
    ...
    private final List<AdminMenuEvent> events = new ArrayList<>();
    private boolean menuFull = true;
    private final String headerName = "Decode_It";
    ...
    public void setMenuFull(boolean menuFull) {
        ...
        for (Component com : panelMenu.getComponents()) {
            if (com instanceof AdminMenuItem) {
                ((AdminMenuItem) com).setFull(menuFull);
            }
        }
    ...
    private void init() {
        ...
        panelMenu = new JPanel(new AdminMenuItemLayout(this));
        ...
        toolBarAccentColor = new ToolBarAccentColorAdmin(this);
    ...
    private void createMenu() {
        ...
        for (int i = 0; i < menuItems.length; i++) {
            ...
            if (menuName.startsWith("~") && menuName.endsWith("~")) {
                ...
                AdminMenuItem menuItem = new AdminMenuItem(this, menuItems[i], index++, events);
    ...
    protected void setSelected(int index, int subIndex) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (com instanceof AdminMenuItem) {
                AdminMenuItem item = (AdminMenuItem) com;
    ...
    protected void runEvent(int index, int subIndex) {
        AdminMenuAction menuAction = new AdminMenuAction();
        for (AdminMenuEvent event : events) {
    ...
    public void addMenuEvent(AdminMenuEvent event) {
        events.add(event);
    }
    ...
    public void hideMenuItem() {
        for (Component com : panelMenu.getComponents()) {
            if (com instanceof AdminMenuItem) {
                ((AdminMenuItem) com).hideMenuItem();
            }
        }
        revalidate();
    }
    ...
    private ToolBarAccentColorAdmin toolBarAccentColor;
